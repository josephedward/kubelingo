...
class KubernetesQuizFeaturesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.static_questions = [
            Question(id='q1', category='Test', prompt='Static Prompt 1', response='res1', validation=[]),
            Question(id='q2', category='Test', prompt='Static Prompt 2', response='res2', validation=[]),
        ]
        self.ai_questions = [
            Question(id='ai-q1', category='Test', prompt='AI Prompt 1', response='ai-res1', validation=[]),
        ]
